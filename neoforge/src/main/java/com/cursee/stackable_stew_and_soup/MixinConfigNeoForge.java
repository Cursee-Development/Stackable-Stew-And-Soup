...
public class MixinConfigNeoForge implements IMixinConfigPlugin {

    static {
        if (Services.PLATFORM.isDevelopmentEnvironment()) {
            Constants.LOG.info("MixinConfigFabric static initialization occurring!");
            Constants.LOG.info(" -  with getCanonicalName() {}", MixinConfigNeoForge.class.getCanonicalName());
            Constants.LOG.info(" -  with descriptorString() {}", MixinConfigNeoForge.class.descriptorString());
            Constants.LOG.info(" -  with getName() {}", MixinConfigNeoForge.class.getName());
            Constants.LOG.info(" -  with getPackageName() {}", MixinConfigNeoForge.class.getPackageName());
            Constants.LOG.info(" -  with getTypeName() {}", MixinConfigNeoForge.class.getTypeName());
            Constants.LOG.info(" -  with getSimpleName() {}", MixinConfigNeoForge.class.getSimpleName());
        }
    }
