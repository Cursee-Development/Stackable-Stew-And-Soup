...
public class MixinConfigFabric implements IMixinConfigPlugin {

    static {
        if (Services.PLATFORM.isDevelopmentEnvironment()) {
            Constants.LOG.info("MixinConfigFabric static initialization occurring!");
            Constants.LOG.info(" -  with getCanonicalName() {}", MixinConfigFabric.class.getCanonicalName());
            Constants.LOG.info(" -  with descriptorString() {}", MixinConfigFabric.class.descriptorString());
            Constants.LOG.info(" -  with getName() {}", MixinConfigFabric.class.getName());
            Constants.LOG.info(" -  with getPackageName() {}", MixinConfigFabric.class.getPackageName());
            Constants.LOG.info(" -  with getTypeName() {}", MixinConfigFabric.class.getTypeName());
            Constants.LOG.info(" -  with getSimpleName() {}", MixinConfigFabric.class.getSimpleName());
        }
    }
